...
class BotHandler(object):
    ...
    def get_answer(self, question):
        if question == '/start':
            return "Nice to meet you! I am an assistive chatbot created by Rohan T and can answer any programming-related questions... How can I help you today?"
        elif question == 'bye' or question == 'bye!':
            return "It was nice talking to you. Sorry I'm not super smart yet. Bye!"
        elif question == 'hi':
            return 'Hey there!'
